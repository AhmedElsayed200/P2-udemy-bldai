export const LikeIcon = ({ id }) => {
  return (
    <svg
      ...
      className="fill-black	w-4"
    >
      <g>
        <path
          d="M490.1,234.464c0-37.6-30.6-68.3-68.3-68.3H316.2v-76.1c0-32.2-9.4-55.4-28-69c-29.4-21.6-69.8-9.3-71.5-8.7
